+++
date = '2026-02-24T19:04:53-06:00'
draft = true
title = 'README.md'
+++
...
- A computing system such as desktop computer or laptop that is running a Windows, MacOS, or Linux-based operating system.
  - This README will assume the user is on a MacOS device when providing instructions.
- A web browser installed on your system for accessing web pages. Suitable browsers include, but are not limited to:
  - Microsoft Edge
  - Google Chrome
  - Firefox
...
- *Provide a sequence of instructions, appropriately structured with headings and/or ordered lists.*

- *Follow the relevant Instruction Guidelines from Chapter 8 of William S. Pfeiffer’s Technical Communication. (See the marking scheme for further details.)*
...
- *Also, make specific references to Etter’s recommendations wherever appropriate. (You may want to start every item in the sequence by referring to some general principle of Etter’s, and then describe a practical step that shows how to apply this general principle. Or alternatively, you may want to start every item in the sequence with a practical step, and then relate it to some general principle of Etter’s.)*

This section will provide comprehensive instructions on how to use the Git version control software to clone remote repositories, format a resume using the Markdown lightweight markup language, host the resume on a website generated statically generated by Hugo, and finally publish the statically generated website on GitHub Pages.
...
- *Include a list of links to online resources that provide additional relevant background information, further reading on the subjects or software you’ve introduced, or other resources that may be useful. Include at least four links, one of which should be to a Markdown tutorial other than the one used in the in-class exercise.*
