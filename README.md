...
It will do so by connecting the technical writing principles described in the course readings. Particularly:
...
The intended audience is Marvin McLaren, or anyone interested in technical writing and meets the prerequisites listed below.

## Prerequisites

To follow the instructions detailed in the next section, you need the following **prerequisites**:
...
This section provides instructions on formatting a resume using Markdown, hosting the resume on a static website generated by Hugo, and  publishing the website using GitHub Pages provided by the GitHub forge.
...
The next step is to create content (a **page**) that you will provide to your website. The most popular format for writing content is Markdown, which is a type of lightweight markup language.
...
Now that you have generated a static website using Hugo and have hosted your resume as a page, the last step is to publish your website on the internet using GitHub Pages.
...
7. Navigate back to the GitHub repository you created in (2.)

8. Click on the 'Actions' menu bar on the top of the page.
   
![Actions](/assets/github_actions.png)

9. Click the green 'New workflow' button on the left panel on the screen.
   
![New workflow button](/assets/new_workflow.png)

10. Search for 'Hugo' using the search bar on the 'Choose your workflow' page
    
![Search Hugo](/assets/search_hugo.png)

11.  Click 'Configure' on the Hugo workflow provided by GitHub
...
12.  Click the green 'Commit changes...' button on the right side of the screen to save the changes.
